...
library(xtable)
filelist=c("5_Undetermined_S0_L001_R1_001_TCGCAT.fastq","6_Undetermined_S0_L001_R1_001_CATAGC.fastq","8_Undetermined_S0_L001_R1_001_GTAGGC.fastq","9_Undetermined_S0_L001_R1_001_TTCAAG.fastq");
labellist=c("baseline_1","fxn_1","baseline_2","fxn_2");
reads=c(99687416,83380298,161628531,116718266);
mappedreads=c(88216257,73132444,142728229,102431968);
totalsgrnas=c(77736,77736,77736,77736);
zerocounts=c(43,198,75,235);
giniindex=c(0.07387829731845663,0.07354276392605896,0.08860991116349692,0.0825793860735905);
...
genboxplot("count_20200409_totalNorm.count_normalized.txt");
@
...
genhistplot("count_20200409_totalNorm.count_normalized.txt");
@
...
genpcaplot("count_20200409_totalNorm.count_normalized.txt");
@
...
<<fig=TRUE,echo=FALSE,width=4.9,height=4.9>>=
genclustering("count_20200409_totalNorm.count_normalized.txt");
@
