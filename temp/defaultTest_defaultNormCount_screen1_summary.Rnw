...
genreporttable<-function(comparisons,ngenes,direction,fdr1,fdr5,fdr25){
  ...
  colnames(xtb)=c("Comparison","Genes","Selection","FDR1%","FDR5%","FDR10%");
  return (xtb);
}
@
...
library(xtable)
comparisons=c("FXN High Gate vs Baseline");
ngenes=c(19280);
...
cptable=genreporttable(comparisons,ngenes,direction,fdr1,fdr5,fdr10);
print(xtable(cptable, caption = "Number of genes detected as significantly enriched in FXN High samples", label = "tab:one",
